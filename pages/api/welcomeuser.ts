    ...
    try {
      ...
      const mailOptions = {
        ...
        html: `
          <html>
          <body>
            <h1>Welcome to Computershop!</h1>
            <p className="pt-1 pb-2 text-lg">Dear ${firstName} ${lastName},</p>
            <p className="pt-1 pb-2 text-lg">Thank you for joining Computershop, your one-stop destination for finding the right bookings and talented taskers. We're excited to have you on board and want to express our gratitude for choosing <Link href="https://www.northexpresskenya.com">Computershop</a>.</p>
            ...
            <ul>
              ...
              <li>Ready to get started? <Link href="https://www.northexpresskenya.comauth/sign-up">Create your account</a>, <Link href="https://www.northexpresskenya.com/browse-bookings">browse bookings</a>, and unlock a world of opportunities on Computershop.</li>
            ...
            <!-- Why Choose Computershop -->
            <h2>Why Choose Computershop:</h2>
            <ul>
            ...
            <p className="pt-1 pb-2 text-lg">Ready to get started? <Link href="https://www.northexpresskenya.comauth/sign-up">Create your account</a>, <Link href="https://www.northexpresskenya.com/browse-bookings">browse bookings</a>, and unlock a world of opportunities on Computershop.</p>
            <p className="pt-1 pb-2 text-lg">Thank you again for choosing Computershop. We look forward to helping you achieve your goals and find the best solutions for your bookings.</p>
            
            <p className="pt-1 pb-2 text-lg">Best regards,<br>The Computershop Team</p>
          </body>
          </html>
        `,
      }
