            ...
            <div className="flex flex-col px-4 py-2">
              ...
              <label className="block cursor-pointer">
                ...
                <div className="mb-4 text-left  text-neutral-500">
                  Hide bookings that are already assigned
                </div>
              </label>
              ...
              <label className="block cursor-pointer">
                ...
                <div className="mb-4 text-left  text-neutral-500">
                  Hide bookings that have offers
                </div>
              </label>
              <div className="flex justify-between">
                ...
                <button className="rounded-3xl bg-amber-500 px-4 py-2 text-white hover:bg-blue-400 focus:outline-none">
                  Apply
                </button>
              </div>
            </div>
