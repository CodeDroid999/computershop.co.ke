...
export default function InfoForm({ handleNextStep }: Props) {
    ...
    return (
      ...
      font-medium outline-none focus:border-blue-500`}
                ...
                <p className="mb-1 p-2 rounded bg-blue-100 text-blue-600 md:text-sm">
                    Note: You do not need to have any prior experience as a teacher to work at Computershop. Please be 100% truthful about your past work experience. Misrepresenting your work experience will result in your application being rejected or your account being banned in the future.
                </p>
                <div className="row">
