      ...
      <div className="">
        <div className="mb-10 flex w-full flex-row items-center justify-between">
          ...
          <div className="hidden md:block">
            <Link
              href="/blog"
              className="rounded-full bg-indigo-400 p-4  font-semibold text-white"
            >
              Visit our blog
            </Link>
          </div>
        ...
        <div className="mb-4 mt-10 block max-w-sm rounded-full bg-indigo-400 px-4 py-3 md:hidden">
          <Link
            href="/blog"
