...
const Accordion: React.FC = () => {
  const faqData = [
    ...
    },
    {
      ...
      answer:
        'So you can post or earn with peace of mind please refer to Computershop Insurance page - terms and conditions apply.',
    },
    {
  ...
  return (
    <div className="mx-5 mx-auto my-4 min-h-screen max-w-screen-xl bg-neutral-100">
      ...
      <div className="flex space-x-2">
        <div className="w-full max-w-sm rounded-full bg-amber-400 px-1 py-1 pt-4 sm:w-[300px]  xl:my-1  xl:py-2 ">
          <Link
            href="/become-a-tutor"
