          ...
          <div className="min-h-[400px] w-full max-w-[400px] rounded-lg bg-white p-4 shadow-2xl">
            ...
            {step === 1 && (
              <div className="flex flex-col items-center gap-2 pt-8">
                ...
                <button
                  onClick={goToStep2}
                  className="mt-16 w-full rounded-full bg-amber-500 py-2 font-semibold text-white"
                >
                  Next
                </button>
              </div>
              ...
              <div className="flex h-full flex-col">
                ...
                <div className="flex flex-col items-center">
                  <p className="mt-1 text-sm font-medium text-green-950">
                    * Computershop automatically includes a Service Fee to cover
                ...
                <button
                  onClick={SubmitForm}
                  className="mt-10 w-full rounded-full bg-amber-500 py-2 font-semibold text-white"
                >
                  Submit new bid
                </button>
              </div>
